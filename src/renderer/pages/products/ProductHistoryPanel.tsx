// ────────────────────────────────────────────────────────
// Costerra ERP — Product History Panel
// Displays the append-only change log for a product.
// ────────────────────────────────────────────────────────
...
export default function ProductHistoryPanel({ productId }: ProductHistoryPanelProps) {
    ...
    useEffect(() => {
        async function fetch() {
            setLoading(true)
            try {
                const res = await window.api.invoke(IPC_CHANNELS.PRODUCT_HISTORY, productId)
